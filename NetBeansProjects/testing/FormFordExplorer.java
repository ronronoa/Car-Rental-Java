...
public class FormFordExplorer extends javax.swing.JFrame {

    public FormFordExplorer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        carModelField.setText("Ford Explorer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormFordExplorer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormFordExplorer().setVisible(true);
            }
        });
    }

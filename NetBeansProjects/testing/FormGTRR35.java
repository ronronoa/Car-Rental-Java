...
public class FormGTRR35 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        carModelField.setText("Nissan GTR R35");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormGTRR35.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormGTRR35().setVisible(true);
            }
        });
    }

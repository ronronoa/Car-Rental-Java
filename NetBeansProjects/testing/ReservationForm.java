...
public class ReservationForm extends javax.swing.JFrame {
    ...
    public ReservationForm() {
        ...
        staffInChargeField.setEditable(false); // optional
    }
    ...
    private void initComponents() {
        ...
        rentalPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, 30));
        ...
        rentalPanel.add(customerNameField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 200, 260, 30));

        jLabel2.setText("Contact Number : ");
        rentalPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, -1, 30));

        jLabel5.setText("Start Date : ");
        rentalPanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 350, -1, 30));

        jLabel6.setText("End Date : ");
        rentalPanel.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, -1, 20));

        jLabel7.setText("Payment Mode : ");
        rentalPanel.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, -1, 20));
        ...
        rentalPanel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 540, 160, 40));
        ...
        rentalPanel.add(contactNumberField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 260, 30));
        ...
        rentalPanel.add(paymentModeComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 315, -1));

        endDateSpinner.setModel(new javax.swing.SpinnerDateModel());
        rentalPanel.add(endDateSpinner, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, 140, -1));

        startDateSpinner.setModel(new javax.swing.SpinnerDateModel());
        rentalPanel.add(startDateSpinner, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 360, 140, -1));

        jLabel8.setText("Address :");
        rentalPanel.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, -1, 30));
        ...
        rentalPanel.add(addressField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 260, 30));
        ...
        rentalPanel.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, 70, -1));
        ...
        rentalPanel.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 470, 90, 30));
        ...
        rentalPanel.add(staffInChargeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 470, 260, 30));

        carModelComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select a car", "Honda Civic", "Toyota Vios", "Mitsubishi Mirage", "Toyota Innova", "Toyota Corolla", "Mitsubishi Montero" }));
        carModelComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carModelComboBoxActionPerformed(evt);
            }
        });
        rentalPanel.add(carModelComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 260, 30));
        rentalPanel.add(imageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 171, 120));
        ...
        rentalPanel.add(btnSaveAsImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 550, -1, -1));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(rentalPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 608, Short.MAX_VALUE)
        );
    ...
    private void carModelComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carModelComboBoxActionPerformed
       String selectedCar = (String) carModelComboBox.getSelectedItem();
        ...
        switch (selectedCar) {
            case "Honda Civic":
                imagePath = "/Car Images/Honda-Civic-Type-R.png";
                break;
            case "Toyota Vios":
                imagePath = "/Car Images/toyotaVios-2.png";
                break;
            case "Mitsubishi Mirage":
                imagePath = "/Car Images/Mirage-G4 (1).png";
                break;
            case "Toyota Innova":
                imagePath = "/Car Images/Toyota-Innova-S.png";
                break;
            case "Toyota Corolla":
                imagePath = "/Car Images/Toyota-Corolla-BIG.png";
                break;
            case "Mitsubishi Montero":
                imagePath = "/Car Images/Montero-S.png";
                break;
            default:

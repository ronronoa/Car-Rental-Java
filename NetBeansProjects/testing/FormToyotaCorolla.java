...
public class FormToyotaCorolla extends javax.swing.JFrame {

   
    public FormToyotaCorolla() {
        initComponents();
    ...
    private void initComponents() {
        ...
        carModelField.setText("Toyota Corolla");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormToyotaCorolla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormToyotaCorolla().setVisible(true);
            }
        });
    }

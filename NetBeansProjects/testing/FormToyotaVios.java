...
public class FormToyotaVios extends javax.swing.JFrame {

    public FormToyotaVios() {
        initComponents();
...
public void Reserve() {
    ...
    private void initComponents() {
        ...
        carModelField.setText("Toyota Vios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormToyotaVios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormToyotaVios().setVisible(true);
            }
        });
    }

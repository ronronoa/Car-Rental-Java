...
public class FormToyota86 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        carModelField.setText("Toyota 86");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormToyota86.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormToyota86().setVisible(true);
            }
        });
    }

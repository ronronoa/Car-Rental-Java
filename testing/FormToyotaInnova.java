...
public class FormToyotaInnova extends javax.swing.JFrame {

    /**
     * Creates new form FormToyotaInnova
     */
    public FormToyotaInnova() {
        initComponents();
    ...
    try {
        ...
        if (rs.next()) {
            ...
            */
            ...
            pst.setString(4, selectedCarModel); // Always "Honda Civic"
    ...
    try {
        ...
        String formattedStartDate = sdf.format(startDate);
        String formattedEndDate = sdf.format(endDate);
        String selectedCarModel = (String) carModelField.getText().trim();
    ...
    private void initComponents() {
        ...
        carModelField.setText("Toyota Innova");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormToyotaInnova.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

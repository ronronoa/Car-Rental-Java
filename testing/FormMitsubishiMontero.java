...
public class FormMitsubishiMontero extends javax.swing.JFrame {
    
    public FormMitsubishiMontero() {
        initComponents();
    ...
    private void initComponents() {
        ...
        carModelField.setText("Mitsubishi Montero");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMitsubishiMontero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class FormHondaCivic extends javax.swing.JFrame {


    public FormHondaCivic() {
        initComponents();
...
public void Reserve() {
    ...
    private void initComponents() {
        ...
        carModelField.setText("Honda Civic");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormHondaCivic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormHondaCivic().setVisible(true);
            }
        });
    }

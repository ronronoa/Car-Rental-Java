...
public class FormMitsubishiMirage extends javax.swing.JFrame {

    public FormMitsubishiMirage() {
        initComponents();
...
public void Reserve() {
    ...
    private void initComponents() {
        ...
        carModelField.setText("Mitsubishi Mirage");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormMitsubishiMirage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

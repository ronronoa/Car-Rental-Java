...
public class FormCamaro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        carModelField.setText("Chevrolet Camaro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCamaro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

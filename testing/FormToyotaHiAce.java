...
public class FormToyotaHiAce extends javax.swing.JFrame {

    public FormToyotaHiAce() {
        initComponents();
    ...
    private void initComponents() {
        ...
        carModelField.setText("Toyota HiAce");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormToyotaHiAce.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

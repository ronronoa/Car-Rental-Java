...
public class Montero extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel37.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Car Images/MonteroFrontView.jpg"))); // NOI18N
        jLabel37.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel38.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Car Images/MonteroBackView.jpg"))); // NOI18N
        jLabel38.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Car Images/MonteroSideView.jpg"))); // NOI18N
        jLabel17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Car Images/MonteroInside.jpg"))); // NOI18N
        ...
        bg2.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, -1, 340));
        ...
        jLabel21.setText("MITSUBISHI MONTERO");

        jLabel22.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel22.setText("2.4-liter MIVEC Intercooled Turbocharged Direct Injection");

        jLabel23.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel23.setText("2025");

        jLabel24.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel24.setText("Diesel Direct Injection ");

        jLabel25.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel25.setText("8-speed automatic with sport mode.");

        jLabel26.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel26.setText("ENGINE DISPLACEMENT (CC) :");

        jLabel27.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel27.setText("2398 cc");

        jLabel34.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel34.setText("SEATING CAPACITY:");

        jLabel36.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel36.setText("4 Passengers");
        ...
        jLabel40.setText("SPECIFICATION");
        ...
        jLabel35.setText("SPECIFICATION");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new FormMitsubishiMontero().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Montero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
